...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item Create a hello world example with defineing two macros. One beeing \ascode{HELLO}, the other \ascode{WORLD}
...
\end{lstlisting}
        \item Create a variable containing the following string: \ascode{"The sky is beautiful!"}. Print it out until
              the 10th character.
        \item Replace the \ascode{'e'} characters in the previous string to the \ascode{'X'} character.
    ...
    \begin{enumerate}
        ...
        \item Iterate trough the following array until we are at the last elemnt, containing a \ascode{NULL (0)} value:
              \begin{lstlisting}[style=CStyle]
