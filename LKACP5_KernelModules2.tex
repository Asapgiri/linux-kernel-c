...
\begin{frame}
    ...
    \bigskip
    \begin{enumerate}
        \item Create kernel module with a \ascode{chardev} named as \ascode{/dev/termbuffer}.
        \item Lets make a buffer on the \textit{Heap}, with the bytelength of \ascode{0x1000}.
              We should be able to write and read from this buffer with the previously created \ascode{/dev/termbuffer}.
        \item Lets extend our previous terminal application, with writing and reading from \ascode{/dev/termbuffer}.
    \end{enumerate}
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item https://elixir.bootlin.com/linux/v6.13.5/source/include/linux/
        \item https://linux-kernel-labs.github.io/refs/heads/master/
    \end{enumerate}
